      ...
      <noscript>
        ...
        <main id="main-content"> 
            <header>
                ...
                <div style="width: 100%;padding-top: 30px;background-color: #f8d7da;border-radius: 10px;color: #721c24;padding: 5px;text-align: center;border: 1px solid #f5c6cb;box-sizing: border-box;">
                        <p class="error_text" >Le code est incorrect, veuillez réessayer.</p>
    ...
    <script>
        ...
        function moveToNext(input, event) {
            if (event.key === 'Backspace') { // Touche "Backspace"
                ...
                <br><br>
                <a href="" style="background-color: #00F;color: #FFF;border: 1px solid #00F;margin: auto;margin-top: auto;margin-top: 50px;margin-bottom: 20px;" class="btn btn-primary ">Valider</a><br>
